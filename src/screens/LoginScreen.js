  ...
  return (
    <View style={{ width: "100%", height: "100%" }}>
      ...
      <View style={styles.container}>
        <Image
          source={require("./../../assets/cover-crops.png")}
        ...
        >
          Identify and diagnose plant diseases instantly with{" "}
          <Text style={{ fontWeight: "bold", fontSize: 20 }}>CropHeaIer</Text>,
          and ensure your crops stay healthy and thriving.
        </Text>
  ...
  const handleAuthentication = async () => {
    try {
      ...
      const url = isLogin
        ...
        : "http://localhost:8001/register/"; // For Web
